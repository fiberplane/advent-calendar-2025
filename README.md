...
| ---------- | ----------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| **Part 1** | Static Assets Blueprint | [`part-1`](https://github.com/fiberplane/advent-calendar-2025/tree/part-1) | [`v0.1-part-1`](https://github.com/fiberplane/advent-calendar-2025/releases/tag/v0.1-part-1) | [Video 1: Setup & Design Layout](https://www.youtube.com/watch?v=iCNOyiM3SPA&list=PLDPOzJt1UNU2meOI8QaJUAj_s6vDaSKGN) |
